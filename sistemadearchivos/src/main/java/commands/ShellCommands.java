...
public class ShellCommands implements Runnable {
    ...
    /**
     * Método ejecutado cuando no se especifica ningún comando. Actualmente no
    ...
    /**
     * Finaliza la ejecución del programa. Imprime un mensaje de salida antes de
     * terminar.
     */
